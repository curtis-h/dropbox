...
<body>
    ...
    <script type="text/javascript">
        ...
        function upload() {
            ...
            var file = globals.uploader.files[0];
            formdata.append('uploader', file, file.name);
            formdata.append('latitude', globals.latitude);
            formdata.append('longitude', globals.longitude);
        ...
        function initialize() {
          globals.form     = document.getElementById('uploader-form');
          globals.uploader = document.getElementById('uploader');

          globals.uploader.onchange = upload;
        ...
        function makeMap(location) {
          var ll = {lat: location.latitude, lng: location.longitude};
          ...
          google.maps.event.addListener(map, 'click', function(event) {
              ...
              globals.latitude  = event.latLng.lat();
              globals.longitude = event.latLng.lng();
              globals.uploader.click();
          });
